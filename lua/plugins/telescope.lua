local M = {
	'nvim-telescope/telescope.nvim', commit='dc7f25c', --tag = '0.1.5',
	...
	keys = {
		...
		{'<leader>d', function() require('telescope.builtin').diagnostics({line_width='full'}) end, desc = "Telescope display diagnostic" },
